...
//           Track how you&apos;re helping reduce food waste and support your
//           community.
//         </p>
//       </div>
//       <div className="border-t border-gray-200 px-4 py-5">
//         <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
//           <div className="bg-emerald-50 rounded-lg p-4 text-center transition-all hover:shadow-md">
...
//             </div>
//           </div>
//           <div className="bg-blue-50 rounded-lg p-4 text-center transition-all hover:shadow-md">
//             <Package2 className="h-8 w-8 text-blue-600 mx-auto" />
...
//             </div>
//           </div>
//           <div className="bg-purple-50 rounded-lg p-4 text-center transition-all hover:shadow-md">
...
//             Monthly Activity
//           </h4>
//           <div className="h-64 bg-gray-50 rounded-lg border border-gray-100 flex items-center justify-center p-4">
//             {/* In a real app, we would add a chart component here */}
//             <div className="text-center">
//               <div className="w-full h-40 bg-gradient-to-t from-emerald-100 to-transparent relative">
//                 <div className="absolute bottom-0 left-0 w-full h-1/3 bg-emerald-200 rounded-sm"></div>
//                 <div className="absolute bottom-0 left-1/4 w-1/6 h-1/2 bg-emerald-300 rounded-sm"></div>
//                 <div className="absolute bottom-0 left-1/2 w-1/6 h-3/4 bg-emerald-400 rounded-sm"></div>
//                 <div className="absolute bottom-0 left-3/4 w-1/6 h-1/4 bg-emerald-300 rounded-sm"></div>
//               </div>
//               <p className="text-gray-500 text-sm mt-2">
//                 Activity visualization for April 2025
//               </p>
//             </div>
//           </div>
//         </div>
...
//               </div>
//               <div className="bg-white p-4 rounded-lg shadow-sm">
//                 <dt className="text-sm text-gray-500">Water Saved</dt>
//                 <dd className="mt-2 text-2xl font-semibold text-gray-900">
...
// src/components/profile/ImpactTracker.tsx
import {
    Award,
    Package2,
    User as UserIcon,
