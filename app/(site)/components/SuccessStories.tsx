...
export default function SuccessStories() {
  return (
    <div id="testimonials" className="bg-white py-20 lg:py-28">
            ...
            <div className="relative text-center lg:text-left">
              ...
              <div className="mt-8">
                <div className="rounded-md shadow">
                  <Link href="/sign-up" className="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-green-600 bg-white hover:bg-green-50">
                    Sign up now
                  </Link>
                </div>
              </div>
